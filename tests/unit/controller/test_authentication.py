...
from controller.manage.common import Roles, OperationFailed
...
@pytest.mark.parametrize("trying_role, user_profile, expectation, message",
                         [(Roles.NONE, None, pytest.raises(OperationFailed), "Authentication failed"),
                          ...
                          (Roles.ADMINISTRATOR | Roles.SUPPORT, user_with_role(Roles.NONE), pytest.raises(OperationFailed), "not have necessary permissions"),
                          (Roles.ADMINISTRATOR | Roles.SUPPORT, user_with_role(Roles.COMMERCIAL), pytest.raises(OperationFailed), "not have necessary permissions"),
