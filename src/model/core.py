...
from .models import Base, Contract, ContractModelMixin, Customer, CustomerModelMixin, Employee, EmployeeModelMixin, Event, Role
...
class Model(EmployeeModelMixin, CustomerModelMixin, ContractModelMixin):
