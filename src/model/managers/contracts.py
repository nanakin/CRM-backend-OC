...
from model.models import OperationFailed, Contract, Employee
...
class ContractModelMixin:
    ...
    def verify_contract_authorization(self, session: Session, connected_employee_id: int, contract: Contract) -> None:  # to-do : type session
