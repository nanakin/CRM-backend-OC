...
@click.option("--contract-uuid", prompt=True, prompt_required=True, type=click.UUID, help="Define the related contract")
...
@click.option("--start", default=None, prompt=False, prompt_required=False, type=click.DateTime(), help="Define the start time")
@click.option("--end", default=None, prompt=False, prompt_required=False, type=click.DateTime(), help="Define the end time")
@click.option("--attendees", default=None, prompt=False, prompt_required=False, type=int, help="Define the number of attendees")
